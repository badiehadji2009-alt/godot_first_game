...
@onready var sfx_player = $EnemySFX 
...
func _ready():
	...
	# 🛑 ربط إشارة HurtBox (يتطلب HurtBox.gd المصحح)
...
func change_state(new_state: State):
	...
	match new_state:
		...
		State.ATTACK:
			...
			if sfx_player: sfx_player.play_attack()
		...
		State.DEAD: 
			# 🛑 الخيار المطلوب: الحذف بعد انتهاء رسوم الموت
...
func _on_animation_finished():
	if anim.animation == "Attack":
		...
		# 🛑 عند انتهاء رسوم الموت، انتقل إلى حالة DEAD ليتم حذفه
